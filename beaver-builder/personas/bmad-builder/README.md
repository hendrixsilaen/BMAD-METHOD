...
Create a complete BMAD compatible module (custom agents and workflows)
...
Edit existing agents while following best practices

### `*edit-module`

Edit existing modules (structure, agents, workflows, documentation)
